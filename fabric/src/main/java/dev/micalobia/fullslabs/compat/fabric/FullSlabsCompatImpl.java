...
public final class FullSlabsCompatImpl {
    ...
    public static void blockus(Mod mod) {
        ...
        MixedHandlers.register(AmethystSlabBlock.class, BlindOnProjectileHitHandler.INSTANCE);
        SlabRegistry.registerVertical(AsphaltSlab.class, AsphaltVerticalSlabBlock::new);
        MixedHandlers.register(AsphaltSlab.class, BlindStepOnHandler.INSTANCE);
    }
